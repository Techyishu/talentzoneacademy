    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Add a new content page to your website</p>
            </div>
        </div>
            ...
            <div class="bg-white/70 backdrop-blur-sm rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('title') }}"
                        required
                        x-data="{ value: '{{ old('title') }}' }"
                        x-model="value"
                        @input="$refs.slugInput.value = value.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/^-|-$/g, '')"
                ...
                <div>
                    ...
                    @error('slug')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Leave blank to auto-generate from title. Only lowercase letters, numbers, and hyphens.</p>
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="2"
                        maxlength="160"
                        x-data="{ count: {{ strlen(old('meta_description', '')) }} }"
