<x-layouts.admin>
    ...
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-xs sm:text-sm text-slate-600">Download {{ $staff->name }}'s ID card as an image</p>
            </div>
            ...
            <div id="idCard" class="id-card">
                ...
                <div class="card-body">
                    ...
                    <div class="photo-container" style="border-color: {{ $school->primary_color ?? '#6366f1' }};">
                        @if($staff->photo)
                            <img src="{{ asset('storage/' . $staff->photo) }}" class="photo" alt="{{ $staff->name }}">
                        @else
    ...
    <script>
        function downloadImage(format) {
            ...
            const filename = 'id_card_{{ $staff->staff_code }}.' + format;
