<x-layouts.admin>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-slate-900 font-heading">Add New Staff Member</h1>
                <p class="mt-1 text-sm text-slate-600">Fill in the staff member information below</p>
            </div>
        ...
        <!-- Form -->
        <form action="{{ route('admin.staff.store') }}" method="POST" enctype="multipart/form-data" class="card-premium p-8">
            @csrf
