<x-layouts.admin>
    <x-slot name="title">Import Staff</x-slot>

    <div class="max-w-3xl mx-auto space-y-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-slate-900 font-heading">Import Staff Members</h1>
                <p class="mt-1 text-sm text-slate-600">Bulk import staff using CSV file</p>
            </div>
        ...
        <x-admin.alert type="info" :dismissible="false">
            <div class="space-y-2">
                ...
                <ol class="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Fill in the staff data following the format in the template</li>
        ...
        <!-- Upload Form -->
        <form action="{{ route('admin.staff.import') }}" method="POST" enctype="multipart/form-data" class="card-premium p-8">
            @csrf
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-200">
                        <tr>
                            <td class="px-4 py-2 text-slate-900">Staff Code</td>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800">Required</span></td>
                            <td class="px-4 py-2 text-slate-600">Staff member full name</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2 text-slate-900">Designation</td>
                            <td class="px-4 py-2"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800">Required</span></td>
                            <td class="px-4 py-2 text-slate-600">e.g., Teacher, Principal</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2 text-slate-900">Phone</td>
                            <td class="px-4 py-2"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800">Required</span></td>
                            <td class="px-4 py-2 text-slate-600">Contact number</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2 text-slate-900">Joining Date</td>
                            <td class="px-4 py-2"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800">Required</span></td>
                            <td class="px-4 py-2 text-slate-600">YYYY-MM-DD format</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2 text-slate-900">Salary</td>
                            ...
                            <td class="px-4 py-2 text-slate-600">Monthly salary amount</td>
                        </tr>
                        <tr>
                            <td class="px-4 py-2 text-slate-900">Status</td>
                            <td class="px-4 py-2"><span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-slate-100 text-slate-800">Optional</span></td>
                            <td class="px-4 py-2 text-slate-600">active or inactive (default: active)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
