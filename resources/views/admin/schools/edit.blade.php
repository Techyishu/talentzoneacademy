    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Update school information and branding</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.schools.update', $school) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="receipt_prefix"
                            id="receipt_prefix"
                            value="{{ old('receipt_prefix', $school->receipt_prefix) }}"
                            required
                            maxlength="10"
                        ...
                        @error('receipt_prefix')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">Uppercase letters only</p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <x-admin.form.file-upload
                            name="logo"
                            label="School Logo {{ $school->logo ? '(Upload new to replace)' : '' }}"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input
                                ...
                                value="{{ old('primary_color', $school->primary_color ?? '#6366f1') }}"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input
                                ...
                                value="{{ old('secondary_color', $school->secondary_color ?? '#10b981') }}"
                                class="h-10 w-20 rounded border border-gray-300 cursor-pointer"
                    ...
                    <div class="md:col-span-2">
                        <x-admin.form.file-upload
                            ...
                            label="Signature Image {{ $school->signature_image ? '(Upload new to replace)' : '' }}"
            ...
            <div class="flex justify-between">
                <form action="{{ route('admin.schools.destroy', $school) }}" method="POST" onsubmit="return confirm('Are you sure? This will delete ALL data for this school. This action cannot be undone.');">
                    @csrf
                    @method('DELETE')
