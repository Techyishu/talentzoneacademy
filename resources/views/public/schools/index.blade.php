<x-public-layout>
    ...
    <section class="relative py-24 overflow-hidden"
        ...
        <div class="absolute inset-0 pointer-events-none overflow-hidden opacity-20">
            ...
            <svg class="absolute bottom-10 left-10 w-24 h-24" viewBox="0 0 100 100" fill="none">
                <path d="M10 20 L30 40 L10 60 L30 80" stroke="white" stroke-width="3" stroke-linecap="round"
        ...
        <div class="container-custom relative z-10 text-center text-white">
            <div class="inline-block px-6 py-3 bg-white/20 backdrop-blur-sm rounded-full mb-6">
                <span class="text-sm font-bold">2 Schools • Excellence in Education</span>
            </div>
            ...
            <p class="text-white/90 text-lg md:text-xl max-w-2xl mx-auto">
                Two uniquely positioned schools, united by a shared commitment to educational excellence.
            </p>
        </div>
    </section>
        ...
        <div class="container-custom relative">
            <div class="text-center mb-16">
                ...
                <p class="text-slate-600 text-lg max-w-2xl mx-auto">
                    Discover our two modern schools designed for excellence and growth.
                </p>
            </div>
    ...
    <section class="section-padding bg-white">
        <div class="container-custom">
            <div class="text-center mb-16">
                ...
                <h2 class="font-display font-bold text-4xl md:text-5xl mb-6" style="color: #2B2826;">
                    Compare <span class="text-gradient-orange">Schools</span>
                </h2>
                <p class="text-slate-600 text-lg max-w-2xl mx-auto">
                ...
                <table class="w-full bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
                    <thead>
                        <tr class="border-b border-slate-200">
                            <th class="px-8 py-6 text-left text-sm font-semibold text-slate-900"
                                style="background-color: #FFF8F0;">Feature</th>
    ...
    <x-public.cta-band title="Can't Decide? Let Us Help!"
        subtitle="Schedule a school tour and experience the Talent Zone Academy difference firsthand."
        primaryText="Book a Tour" primaryUrl="{{ route('contact') }}" />
</x-public-layout>